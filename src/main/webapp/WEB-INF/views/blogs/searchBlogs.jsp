...
<form id="pagerForm" method="post" action="searchBlogs">
	...
	<div class="row search-bar">
		<div class="col-sm-6">
			...
			<a class="btn btn-success" data-history="repairOrder" href="searchBlogs">刷&nbsp;&nbsp;新</a>
		</div>
	</div>
</form>
		...
		<table class="table table-hover td-relative">
			...
			<c:forEach items="${page.content}" var="ts">
				...
				<tr>
					...
					<td>
						<a class="btn btn-success" href="listComment?blogsId=${ts.blogsId}">查看</a>
						<!-- 
						<%
